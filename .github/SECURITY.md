...
Security is a priority. We maintain a proactive stance to identify and fix vulnerabilities in **gtask-extractor**.

<br/>

## 🛠️ Supported & Maintained Versions
Any released version of **gtask-extractor** that is not marked as deprecated is actively supported and maintained.
